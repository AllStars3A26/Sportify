...
public class terrain {
    ...
    public terrain(int id_terrain, String nom_terrain, String type_terrain, String description_terrain, String adresse_terrain) {
    ...
    public String toString() {
        return "tournoi{" + "id_terrain=" + id_terrain + ", nom_terrain=" + nom_terrain + ", type_terrain=" + type_terrain + ", description_terrain=" + description_terrain + ", adresse_terrain=" + adresse_terrain + '}';
    }
