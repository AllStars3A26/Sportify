    ...
    private void exel(ActionEvent event) throws SQLException, FileNotFoundException, IOException {
        ...
        System.out.println();
         PreparedStatement pst = cnx.prepareStatement(query);
            ...
            XSSFSheet sheet = wb.createSheet("Détails Terrains");
            XSSFRow header = sheet.createRow(0);
            header.createCell(0).setCellValue("id_terrain");
            header.createCell(1).setCellValue("nom_terrain");
            header.createCell(2).setCellValue("type_terrain");
            header.createCell(3).setCellValue("description_terrain");            
            header.createCell(4).setCellValue("adresse_terrain");
            header.createCell(5).setCellValue("disponibilite");
            
            int index = 1;
            while(rs.next()){
                XSSFRow row = sheet.createRow(index);
                row.createCell(0).setCellValue(String.valueOf(rs.getInt("id_terrain")));
                row.createCell(1).setCellValue(rs.getString("nom_terrain"));                
                row.createCell(2).setCellValue(rs.getString("type_terrain"));
                row.createCell(3).setCellValue(rs.getString("description_terrain"));
                row.createCell(4).setCellValue(rs.getString("adresse_terrain"));
                row.createCell(5).setCellValue(rs.getString("disponibilite"));
                index++;
                System.out.println(index);
            }
            
            FileOutputStream file = new FileOutputStream("Détails_Terrains.xlsx");
            ...
            File myfFile = new File("C:/Users/Lenovo/Desktop/Détails_Terrains.xlsx");
            System.out.println(myfFile);
